...
public class PrawnLaserArm
{
    ...
    public void Patch()
    {
...
#if BZ
            TechType.SeaTruckUpgradeMiningArm
#elif SN1
        ...
        var scanningGadget = customPrefab.SetUnlock(TechType.Diamond);
        scanningGadget.WithPdaGroupCategoryAfter(TechGroup.VehicleUpgrades, TechCategory.VehicleUpgrades, TechType.ExosuitTorpedoArmModule);
        scanningGadget.WithCompoundTechsForUnlock([TechType.Diamond, TechType.Magnetite]);
#if BZ
        ...
        customPrefab.SetVehicleUpgradeModule(EquipmentType.ExosuitArm, QuickSlotType.Chargeable)
